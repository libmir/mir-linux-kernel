/++
Auto-generated Linux syscall constants for SystemZ
+/
module mir.linux.arch.systemz.uapi._asm.unistd;
...
enum NR_putpmsg = 189;
enum NR_vfork = 190;
enum NR_getrlimit = 191;
enum NR_lchown = 198;
enum NR_getuid = 199;
enum NR_getgid = 200;
enum NR_geteuid = 201;
enum NR_getegid = 202;
enum NR_setreuid = 203;
enum NR_setregid = 204;
enum NR_getgroups = 205;
enum NR_setgroups = 206;
enum NR_fchown = 207;
enum NR_setresuid = 208;
enum NR_getresuid = 209;
enum NR_setresgid = 210;
enum NR_getresgid = 211;
enum NR_chown = 212;
enum NR_setuid = 213;
enum NR_setgid = 214;
enum NR_setfsuid = 215;
enum NR_setfsgid = 216;
...
enum NR_statx = 379;
enum NR_s390_sthyi = 380;
enum NR_kexec_file_load = 381;
enum NR_io_pgetevents = 382;
enum NR_rseq = 383;
