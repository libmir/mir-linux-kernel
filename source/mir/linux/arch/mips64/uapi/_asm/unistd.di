...
enum NR_clone3 = 5435;
enum NR_close_range = 5436;
enum NR_openat2 = 5437;
enum NR_pidfd_getfd = 5438;
enum NR_faccessat2 = 5439;
enum NR_process_madvise = 5440;
enum NR_epoll_pwait2 = 5441;
enum NR_mount_setattr = 5442;
enum NR_quotactl_fd = 5443;
enum NR_landlock_create_ruleset = 5444;
enum NR_landlock_add_rule = 5445;
enum NR_landlock_restrict_self = 5446;
enum NR_process_mrelease = 5448;
