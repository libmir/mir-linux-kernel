/++
Auto-generated Linux syscall constants for AArch64
+/
module mir.linux.arch.aarch64.uapi.asm.unistd;
...
enum NR_sync_file_range2 = 84;
enum NR_sync_file_range = 84;
...
enum NR_swapon = 224;
enum NR_swapoff = 225;
enum NR_mprotect = 226;
enum NR_msync = 227;
enum NR_mlock = 228;
enum NR_munlock = 229;
enum NR_mlockall = 230;
enum NR_munlockall = 231;
enum NR_mincore = 232;
enum NR_madvise = 233;
enum NR_remap_file_pages = 234;
enum NR_mbind = 235;
enum NR_get_mempolicy = 236;
enum NR_set_mempolicy = 237;
enum NR_migrate_pages = 238;
enum NR_move_pages = 239;
...
enum NR_access = 1033;
enum NR_rename = 1034;
enum NR_readlink = 1035;
enum NR_symlink = 1036;
enum NR_utimes = 1037;
enum NR_syscalls = (__NR3264_lstat+1);
enum NR_pipe = 1040;
enum NR_dup2 = 1041;
enum NR_epoll_create = 1042;
enum NR_inotify_init = 1043;
enum NR_eventfd = 1044;
enum NR_signalfd = 1045;
enum NR_syscalls = (NR_signalfd+1);
enum NR_sendfile = 1046;
enum NR_ftruncate = 1047;
enum NR_truncate = 1048;
enum NR_stat = 1049;
enum NR_lstat = 1050;
enum NR_fstat = 1051;
enum NR_fcntl = 1052;
enum NR_fadvise64 = 1053;
enum NR_newfstatat = 1054;
enum NR_fstatfs = 1055;
enum NR_statfs = 1056;
enum NR_lseek = 1057;
enum NR_mmap = 1058;
enum NR_syscalls = (NR_mmap+1);
enum NR_alarm = 1059;
enum NR_getpgrp = 1060;
enum NR_pause = 1061;
enum NR_time = 1062;
enum NR_utime = 1063;
enum NR_creat = 1064;
enum NR_getdents = 1065;
enum NR_futimesat = 1066;
enum NR_select = 1067;
enum NR_poll = 1068;
enum NR_epoll_wait = 1069;
enum NR_ustat = 1070;
enum NR_vfork = 1071;
enum NR_oldwait4 = 1072;
enum NR_recv = 1073;
enum NR_send = 1074;
enum NR_bdflush = 1075;
enum NR_umount = 1076;
enum NR_uselib = 1077;
enum NR__sysctl = 1078;
enum NR_fork = 1079;
enum NR_syscalls = (NR_fork+1);
enum NR_fcntl = __NR3264_fcntl;
enum NR_statfs = __NR3264_statfs;
enum NR_fstatfs = __NR3264_fstatfs;
enum NR_truncate = __NR3264_truncate;
enum NR_ftruncate = __NR3264_ftruncate;
enum NR_lseek = __NR3264_lseek;
enum NR_sendfile = __NR3264_sendfile;
enum NR_newfstatat = __NR3264_fstatat;
enum NR_fstat = __NR3264_fstat;
enum NR_mmap = __NR3264_mmap;
enum NR_fadvise64 = __NR3264_fadvise64;
enum NR_stat = __NR3264_stat;
enum NR_lstat = __NR3264_lstat;
enum NR_fcntl64 = __NR3264_fcntl;
enum NR_statfs64 = __NR3264_statfs;
enum NR_fstatfs64 = __NR3264_fstatfs;
enum NR_truncate64 = __NR3264_truncate;
enum NR_ftruncate64 = __NR3264_ftruncate;
enum NR_llseek = __NR3264_lseek;
enum NR_sendfile64 = __NR3264_sendfile;
enum NR_fstatat64 = __NR3264_fstatat;
enum NR_fstat64 = __NR3264_fstat;
enum NR_mmap2 = __NR3264_mmap;
enum NR_fadvise64_64 = __NR3264_fadvise64;
enum NR_stat64 = __NR3264_stat;
enum NR_lstat64 = __NR3264_lstat;
